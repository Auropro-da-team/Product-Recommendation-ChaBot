...
import { sendMessageToChatbot, startNewConversation, getSessionId } from "../api";
...
function Chatbot({ selectedChat, updateChatHistory, chatHistory = [], loading }) {
  ...
  useEffect(() => {
    ...
    setConversationId(selectedChat?.conversation_id || null);
